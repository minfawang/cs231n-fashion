...
class ImageDataGenerator(object):
    ...
    def flow_from_directory(self, directory,
        ...
        # Arguments
            ...
            class_mode: One of "categorical", "binary", "sparse", "multilabel",
...
# #         batch_img_shape = (batch_size,) + self.image_shape
        ...
        features_dim = 12331  # TODO(minfa): Update 100 to feature dim.
        
        num_color_bins = 10 # Number of bins in the color histogram

        feature_fns = [
            feature_extractor.hog_feature,
            lambda img: feature_extractor.color_histogram_hsv(img, nbin=num_color_bins)
        ]
        ...
        for i, j in enumerate(index_array):
            ...
            x_features = feature_extractor.extract_features(np.expand_dims(x, axis=0), feature_fns)
